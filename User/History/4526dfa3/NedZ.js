                ...
                <div className='drinks__container'>
                    ...
                    <div className="drinks__container__right">
                        ...
                        {!option ?
                            ...
                            :
                            option === "bottle" ? <FormBottle getAllDrinks={getAllDrinks} setOption={setOption} /> :
                                option === "drink" ? <FormDrink getAllDrinks={getAllDrinks} setOption={setOption} /> :
                                    <FormEdit getAllDrinks={getAllDrinks} setOption={setOption} data={option} />
                        }
                    </div>
                </div>
            </div>
