...
const Statistics = () => {
  ...
  const [selectClub, setSelectClub] = useState(!getDetails);
              ...
              <div className="total-earnings-section">
                ...
                <div className="total-earnings-row">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `${routes.owner.statisticsHistory}/${getDetails.nameParty}/total-facturado`
                      )
                    }
                  >
                    Ver detalle
