...
import PdfButton from '../../../components/organizer/PdfButton/PdfButton'
import './Statistics.scss'
import { Header } from '../../../components/global/Header/Header';
import { useNavigate, useParams } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import CalendarPicker from '../../../components/CalendarPicker/CalendarPicker'
import { detailsParty, getbyId, getStatisticsDetailsHistory, getStatisticsDetailsTop5, getStatisticsDetailsTotal } from '../../../redux/store/slices/Organizer';
export const Statistics = () => {
  ...
  useEffect(() => {
    if(!getTop.length || !getTotal.totalVentasFinal) {
      ...
      id ? dispatch(detailsParty({id}))
      : dispatch(getbyId(idParty))
    }
  }, [])
  const others = () => {
    let others = 0
