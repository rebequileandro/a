...
import { getCash } from '../../../redux/slices/organizer/organizer';
...
const CashRegister = () => {
  ...
  const getCashRegister = useSelector(
    (state) => state.organizer.organizer.cash
  );
  const getDetail = useSelector((state) => state.organizer.organizer.details);
  ...
  return (
    <>
      ...
      <div className="cash-register-container">
        <Header
          backbutton={() => navigate(`${routes.owner.club}/${id}`)}
          OrganizerParty={{
            party: 'ajustes',
