...
export const updateInventoryBar = (id, data) => async (dispatch) => {
    const response = await axios.put(`${REACT_APP_API}/organizer/inventory/agregarinventario/${id}`, data)
    console.log("UPDATE INVENTORY BARS", response)
