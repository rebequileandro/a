...
export const slice = createSlice({
    ...
    reducers: {
        ...
        resetSquares: (state) => {
            state.cashierSquares = initialState.cashierSquares
            state.bartenderSquares = initialState.bartenderSquares
        },
...
export const getTeam = (id) => async (dispatch) => {
    try {
        const response = await axios.post(`${REACT_APP_API}/organizer/party/allteam`, { idParty: id })
...
export const deleteTeam = (id) => async () => {
    console.log("ID", id)
    try {
        const response = await axios.delete(`${REACT_APP_API}/team/settings/delete`, { idTeam: id })
...
export const getInventory = (id) => async (dispatch) => {
    try {
        const response = await axios.post(`${REACT_APP_API}/organizer/inventory/all`, id)
        console.log("all inventory", response)
        dispatch(setInventory(response.data.data.bottles))
    } catch (error) {
        console.log(error)
    }
}
...
export const updateInventoryGeneral = (id, idParty, data) => async (dispatch) => {
    try {
        ...
        console.log("Update inventoty", response)
