  ...
  return (
      <>
        <div className='organizer-settings-container'>
            <Header 
                backbutton={currentUser.rol === "organizador" ? () => navigate("/settings/clubs") : null}
            ...
            <>
                ...
                <>
                <hr/>
                <div className='row-container' onClick={() => navigate(`/settings/inventory/${id}`)}>
                    <h2>inventario</h2>
                ...
                <hr/>
                <div className='row-container' onClick={() => navigate(`/settings/menu/${idReplace}`)}>
                    <p style={{fontWeight: currentUser.rol === "unitManager" ? 600 : 300}}>menu</p>
                    <img src={row} alt="flecha" />
                </div>
                <hr/>
                <div className='row-container' onClick={() => navigate(`/settings/cash/${idReplace}`)}>
                ...
                {currentUser.rol === "organizador" &&
                <>
                <div className='row-container' onClick={() => navigate('/settings/unit-manager')}>
                    <p>gerente de unidad</p>
                    <img src={row} alt="flecha" />
                </div>
                <hr/>
                </>}
                <div className='row-container' onClick={() => navigate('/settings/bartendes')}>
                    <p>bartender</p>
                    <img src={row} alt="flecha" />
                </div>
                <hr/>
                <div className='row-container' onClick={() => navigate("/settings/cashiers")}>
                    <p>cajeros</p>
                    <img src={row} alt="flecha" />
                </div>
                <hr/>
