      ...
      <div className="content-right">
        ...
        <ul>
          <li className="item one">
            Tus clientes pueden cargar su efectivo y acreditar saldo.
          </li>
          <li className="item two">
            Funciona de la misma manera que el pago con tarjeta.
          </li>
          <li className="item three">
            Asegura una experiencia de compra rápida y eficiente.
          </li>
          <li className="item four">
            Elimina la necesidad de las transacciones en efectivo.
          </li>
        </ul>
