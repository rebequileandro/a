...
export const EditProduct = ({
  ...
  const club = useSelector((state) => state.organizer.organizer.details);
              ...
              <div className="right-container">
                ...
                <div className="form">
                  <div className="input-container">
                    <label>Precio</label>
                    <div className="input-wrapper input__price">
                      <input
                        type="number"
                        name="price"
                        value={input.price}
                  ...
                  <div className="input-container">
                    ...
                    <div className="input-container__prefix-wrapper">
                      <span>%</span>
                      <div className="input-wrapper input__discount">
                        <input
                          type="number"
                          name="discount"
                  ...
                  <div className="input-container">
                    ...
                    <p className="input-container__price">
                      {formatPrice(finalPriceShow, club.currency)}
                    </p>
                  </div>
                </div>
                      ...
                      <div className="dropdown-section-column__minutes">
                        ...
                        <div className="input-wrapper  input-wrapper--width-time">
                          <input
                            ...
                            onChange={(e) => handleOnChange(e)}
                            onKeyDown={(e) => {
                              const validChars = '0123456789Backspace';
...
//CODIGO PARA EDITAR LOS INGREDIENTES
