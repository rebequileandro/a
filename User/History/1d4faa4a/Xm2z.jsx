...
import "./tabs.css";
const Tabs = ({ optionsTabs, setState, currentTab, size = "m" }) => {
  ...
  return (
    <div className={`tabs-container-xnodui tabs-container-xnodui--${size}`}>
      <div className="tabs" ref={tabsRef}>
        {optionsTabs?.map((tab, i) => (
          <Fragment key={tab.value + i}>
            ...
            />
            <label htmlFor={tab.value + id} className="label">
              {tab.label}
            </label>
          </Fragment>
        ))}
