...
export const Statistics = ({total = '3,232'}) => {
  ...
  return (
    <>
      <div className="statistics-container">
          ...
          <div className="chart-wrapper">
            <div className="chart">
              ...
              <Chart
                ...
                second={getTop[0]?.cantidadFinal}
                third={getTop[0]?.cantidadFinal}
                others={others()}
                fourth={getTop[0]?.cantidadFinal}
                fifth={getTop[0]?.cantidadFinal}
              />
            </div>
            <div className="first">
        ...
        <div className="data-container">
          <div className="secodary-container">
            ...
            <div className="number-container">
              <h1>${getTotal.valorPromedioPedido}</h1>
      ...
      {isOpen && <CalendarPicker setIsOpen={setIsOpen} currentDate={date} setCurrentDate={setDate}/>}
    </>
  );
}
