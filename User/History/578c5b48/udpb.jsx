...
import { detailsParty, getStatisticsDetailsHistory, getStatisticsDetailsTop5, getStatisticsDetailsTotal, getStatisticsHistory, getStatisticsTop5, getStatisticsTotal } from '../../../redux/store/slices/Organizer';
export const Statistics = () => {
  ...
  useEffect(() => {
    dispatch(getStatisticsDetailsHistory({
      idParty: id,
      desde: initialValue.initial,
      hasta: initialValue.end
    }))
    dispatch(getStatisticsDetailsTotal({
      idParty: id,
      desde: initialValue.initial,
      hasta: initialValue.end
    }))
    dispatch(getStatisticsDetailsTop5({
      idParty: id,
      desde: initialValue.initial,
      hasta: initialValue.end
    }))
        ...
        <div className="chart-container">
          ...
          <div className="chart-wrapper">
           ...
           <div className='details-button'>
            <button 
              className='details'
              onClick={() => navigate(`/historial-de-estadisticas/${getDetails[0].nameParty}/mas-pedidos`)}>
                {`Ver detalle >`}
            </button>
           </div>
        </div>
