            ...
            <div className="settings-clubs__menu">
              {e.worker?.length ? (
                ...
                <div
                  ...
                  onClick={() =>
                    role === 'bartender'
                      ? navigate(routes.owner.newBartender)
                      : navigate(routes.owner.newCashier)
                  }
                >
                  <h3 className="heading-tertiary-main settings-clubs__no-staff">
                    No hay staff en esta barra
                  </h3>
                </div>
              )}
            </div>
