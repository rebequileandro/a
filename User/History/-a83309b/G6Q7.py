...
print(meta_data.splits['train'].num_examples)
print(meta_data.splits['test'].num_examples)
#to train faster it is divided into training batches
LOT_SIZE = 32

#random order print(meta_data.splits['train'].num_examples) ----> 60000
training_data = training_data.repeat().shuffle(60000)