    ...
    <div className="settings-clubs layout-primary">
      ...
      <div className="settings-clubs__menu">
        <div
          ...
          onClick={() => navigate(routes.owner.inventory)}
        >
          <h3 className="heading-tertiary-main settings-clubs__title">
            Inventario
          </h3>
        ...
        <div className="settings-clubs__content-menu">
          <h3 className="heading-tertiary-main settings-clubs__title">Menú</h3>
          <img
            className="settings-clubs__image-arrow"
            src={arrow}
            alt="arrow"
      ...
      <div className="settings-clubs__menu">
        <div className="settings-clubs__content-menu">
          <h3 className="heading-tertiary-main settings-clubs__title">Staff</h3>
          <img
            className="settings-clubs__image-arrow"
            src={arrow}
            alt="arrow"
        ...
        <div className="pink-gradient-line-1">&nbsp;</div>
        <div className="settings-clubs__content-menu">
          <h3 className="heading-tertiary-main settings-clubs__title">Caja</h3>
          <img
            className="settings-clubs__image-arrow"
            src={arrow}
            alt="arrow"
