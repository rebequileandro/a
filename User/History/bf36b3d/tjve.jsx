...
export const SelectDrink = ({
  ...
  const handleSubmit = (e) => {
    ...
    let newData = [];
    selected === 'botellas'
      ? (allData = [getAllDrinks, getAllPacks, getAllAdditional, drinks])
      : selected === 'tragos'
      ? (allData = [getAllBottles, getAllPacks, getAllAdditional, drinks])
      : selected === 'sin alcohol'
      ? (allData = [getAllBottles, getAllPacks, getAllDrinks, drinks])
      : selected === 'packs' &&
        (allData = [
          getAllDrinks,
          getAllBottles,
        ...
        <div className="popup-select-drink">
          ...
          <p>
            ...
            {selected === 'botellas'
              ...
              ? 'las bebidas'
              : 'los'}{' '}
            {selected} disponibles en tu menu
          </p>
