...
export default function MyAccount() {
  ...
  return (
    <div className="my-account layout-primary">
      ...
      <div className="my-account__support-container ">
        <div className="my-account__support-wrapper-icon">
          <div className="my-account__support-icon-background">
            <div className="my-account__support-icon">
              <img className="my-account__icon" src={support} alt="" />
            </div>
          </div>
        </div>
