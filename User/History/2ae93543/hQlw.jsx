    ...
    (async () => {
      ...
      try {
        ...
        if (user.success === false) {
          ...
          user.rol === "fiestero" ? (!currentClub ? navigate(routes[0].partyUser.searchClub.url) : navigate(routes[0].partyUser.home.url)) :
          user.rol === "organizer" ? navigate('/ouwner/home') :
          user.rol === "bartender" ? navigate('/bartender/home') :
          user.rol === "cashier" && navigate('/cashier/home') 
        }
      } catch (err) {
        setInputErrors({
          ...inputErrors,
