...
const Form = ({ isOpen, setIsOpen }) => {
  const { REACT_APP_API, REACT_APP_HUBSPOT_PORTAL_ID, REACT_APP_HUBSPOT_FORM_GUID } = process.env
  const [loading, setLoading] = useState(false);
  // const { HubSpot } = useScript(
    ...
    if (!loading) {
      ...
      if (
        ...
        try {
          ...
          const responseHS = await axios.post(`https://api.hsforms.com/submissions/v3/integration/submit/${process.env.}/fcc69886-915b-4fef-b35f-27850ef461e1`)
