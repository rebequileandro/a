  ...
  const handleSubmit = async (e) => {
    ...
    if (!inputDrink.nameDrink) {
      ...
      try {
        ...
        //
        // await axios.put(
        //   `${process.env.REACT_APP_API}/shooza/drink/${data._id}`,
        //   {
        //     imageDrink: image,
        //     typeDrink: inputDrink.typeDrink.toLowerCase(),
        //     nameDrink: inputDrink.nameDrink.toLowerCase(),
        //     activeDrink: false,
        //     totalMinOrder: 2,
        //     recipe: inputDrink.recipe,
        //     drinkMl: 300,
        //   }
        // );
      ...
      <form className="form-card__form-container" onSubmit={handleSubmit}>
        <div className="form-card__row">
          ...
          <div className="form-card__right-container">
            ...
            <button className="form-card__trash-button" type="button">
