    ...
    <>
      ...
      <section className="layout-primary section-party-selection">
        {isLoading ? (
          ...
          <>
            <img src={noClub} alt="no hay club" className="no-club-image" />
            <h3 className="heading-secondary-main no-club-text">
              Todavía no has registrado ningún local en Shooza
            </h3>
          </>
        )}
      </section>
