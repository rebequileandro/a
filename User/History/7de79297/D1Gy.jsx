...
const FormMessage = ({
  ...
  useEffect(() => {
    ...
    if (status !== "Online") {
      recRefBtn.current?.removeEventListener("touchstart", touchstart);
      recRefBtn.current?.removeEventListener("touchmove", touchmove);
      recRefBtn.current?.removeEventListener("touchend", touchend);
    }
