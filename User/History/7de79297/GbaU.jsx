...
const FormMessage = ({
  ...
  const { audioChunks, setAudioChunks, startRecording, stopRecording } =
    useAudioRecorder(setIsOpenOptionpopup);
  ...
  useEffect(() => {
    ...
    const touchstart = async (e) => {
      ...
      console.log(typeof recording === "error");
  ...
  return (
    <>
      ...
      <OptionPopup
        ...
        title={isOpenOptionpopup?.title}
        description={isOpenOptionpopup?.description}
        options={{
          btnA: "Aceptar",
          onClickA: () => setIsOpenOptionpopup(null),
        }}
      />
    </>
  );
