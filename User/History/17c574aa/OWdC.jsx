...
export default function useSubmitForm({
  ...
  const deliveredMethod = useSelector(getFloorBar);
      ...
      try {
        ...
        if (methodsCheck.includes(method.name)) {
          const postData = {
            ...
            idParty: club._id,
            total: total,
            nameBarra: deliveredMethod?.bar,
            namePista: deliveredMethod?.floor,
            nameTable: deliveredMethod?.table,
