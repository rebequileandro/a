...
const Notification_Request_Permission = () => {
  return (
    <Popup_Options
      ...
      description="Te recomendamos activar esta opción para saber cuando tu orden esté lista Te recomendamos activar esta opción para saber cuando tu orden esté lista"
    />
  );
};
