...
const dataPage = {
  ...
  projects: [
    {
      title: 'Bizarrap',
      description: `En la web de bizarrap podras encontrar toda la informacion sobre sus proximos shows, 
      tambien podras encontrar un calendario con todas sus precentaciones pasadar, fotos y videos de las mismas `,
      image: bizarrap,
