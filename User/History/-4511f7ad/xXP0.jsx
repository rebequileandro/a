    ...
    <div className="what-is-wedrink-container">
      <div className="baner">
        ...
        <div className="image-container"
          ...
          <span id="ellipse-pink-one" className="ellipse-pink one" />
          <span id="ellipse-pink-two" className="ellipse-pink two" />
          <span id="ellipse-pink-three" className="ellipse-pink three" />
          <img
          ...
          <span data-lax-translate-x="0 0, vh 235" className="ellipse one" />
          <span id="ellipse-two" className="ellipse two" />
        </div>
      </div>
    </div>
  );
