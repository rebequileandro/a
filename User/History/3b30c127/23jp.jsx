...
const ShoozaInformation = () => {
  return (
    <div className="shooza-information-container" id="como-funciona">
      ...
      <img src={Elipse1} alt="" className="circle-red circle-1" />
      <img src={Elipse5} alt="" className="circle-red circle-short-5" />
      <img src={Elipse6} alt="" className="circle-red circle-short-6" />
    </div>
  );
};
