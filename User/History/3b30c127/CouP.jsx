  ...
  return (
    <div className="shooza-information-container" ref={setReference}>
      ...
      <section className="left-section">
        ...
        <p>
          Podrás conocer en detalle el estado de tus pedidos en tiempo real. Se
          te notificará al móvil si es que tu orden se está preparando, si está
          a punto de estar lista y si está terminada.
        </p>
        <a
          href={links.partyFi}
          target="_blank"
