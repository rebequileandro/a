...
import imgHeader from '../../../assets/Fiestero/Images/home_header_image-4.webp';
...
import PopupManager from '../../../components/global/PopupSignUp/PopupManager';
import { clearCheckout } from '../../../redux/slices/partyUser/checkout';
...
export default function Home_events_fiestero() {
  ...
  useEffect(() => {
    ...
    dispatch(getMainPageEventsHistory(currentUser._id));
  ...
  return (
    <>
      <Header />
      <PopupManager currentUser={currentUser} />
        ...
        {checkSearchContentUserHistory.length ? (
          <section className="section-recommended-events">
            <div className="section-recommended-events__header">
              ...
              {/* Comentado hasta que podamos seccionar estas divisiones
