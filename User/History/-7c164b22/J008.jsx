...
import './Scanner.scss'
import { TabBarBarman } from '../TabbarBartender/TabBarBarman'
...
export const Scanner = () => {
  ...
  return (
    <div className='barman-container'>
        <Header welcome={true}/>
        {(!isOpen && getStatus === 200) ? <Ticket order={order} status={JSON.parse(order?.orderDelivered) === true && 'entregar'}/> : null}
