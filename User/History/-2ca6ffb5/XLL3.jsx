...
const Activities = () => {
  return (
    <>
      ...
      <div className="organizer-activities layout-primary">
        <img
          src={noActivities}
          className="organizer-activities__no-activities"
          alt="no hay actividades"
        />
        <h2 className="heading-secondary-main organizer-activities__description">
