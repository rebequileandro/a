      ...
      <section className="charge-point layout-primary">
        <div className="charge-point__user-container">
          <div className="charge-point__image-wrapper">
            <div className="charge-point__profile-picture-bg">
              <div className="charge-point__profile-picture">
                <img
                  className={`charge-point__${!user?.image ? 'icon' : 'image'}`}
