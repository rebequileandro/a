...
const ChargePoint = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (amount >= 50 && amount <= 50000) {
      ...
      setStatus({
        status: false,
        title: `Porfavor cargar entre ${formatPrice(
          50,
          getClub.currency
        )}  y ${formatPrice(50000, getClub.currency)}`
      });
      setBlockSubmit(false);
    }
  };
  ...
  return (
    <>
      <Header backbutton={() => navigate(-1)} title={'Cargar puntos'} />
          ...
          <div className="charge-point__title-wrapper">
            <h3 className="heading-tertiary-main heading-tertiary-main--upper charge-point__title">
              ...
              <span className="charge-point__title-minmax">
                {`Min: ${formatPrice(50, getClub.currency)} - Max:1000€`}
              </span>
            </h3>
