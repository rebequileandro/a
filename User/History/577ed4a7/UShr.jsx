...
import { getOrders } from '../../../redux/slices/cashier/order';
...
const Orders = ({ socket }) => {
  ...
  const allOrdersState = useSelector((state) => state.cashier.orders);
  ...
  const getAllOrders = () => {
    dispatch(
      getOrders({
        ...
        idParty: '64ee6dd1384433953d643786',
        bartender: '64ee72b5384433953d643a34'
      })
    );
  };
