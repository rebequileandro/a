...
import { catchStatus, selectDrinks } from '../../../../redux/slices/Organizer';
...
export const DetailsCategories = ({ categoryType }) => {
  ...
  useEffect(() => {
    ...
    if (categoryType === 'additional') {
      setDetails(getAllAdditional);
      dispatch(selectDrinks(getAllAdditional));
  ...
  const handleOnClick = () => {
    ...
    categoryType === 'additional' && setSelected('adicionales');
  };
