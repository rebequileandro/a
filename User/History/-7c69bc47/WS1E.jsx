...
const Home = ({ setIsOpen }) => {
  return (
    <section id="inicio" className="home-container">
      ...
      >
        <source
          src={window.innerWidth <= 500 ? backgroundMobile : background}
          type="video/webm"
        />
      </video>
        ...
        <div className="slogan">
          <div className="home-container__title-wrapper">
            <h1 className="home-container__title">
              El futuro del comercio en eventos.
            </h1>
            <div className="underline"></div>
          </div>
          <p className="home-container__description">
            Transformando las ventas, de minutos a segundos. Ahora tus clientes
            ordenan sin hacer filas para pagar.
          </p>
