...
const Login = () => {
  ...
  return (
    <div className="login">
      ...
      >
        {loginData?.map((e, i) => (
          <SwiperSlide className="login__slide" key={i}>
              ...
              {e.slide?.map((input, index) => (
                <Input
                  ...
                  inputProps={{
                    ...
                    onChange: i === 0 ? handleChangeLogin : handleChangeSignup,
                    required: true,
                  }}
                  label={input.label}
                  error={
        ...
        <SwiperSlide className="login__slide">
          <img src="/assets/medbot.png" alt="medbot" />
          <div className="login__slide__form">
            <h3 className="login__slide__form__title">Valida tu identidad:</h3>
