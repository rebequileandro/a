        ...
        <div className="chart-container">
          ...
          <div className="chart-wrapper">
            <div className="chart">
              ...
              <ChartOR
                first={{
                  total: getTop[0]?.cantidadFinal ? getTop[0]?.cantidadFinal : null,
                  name: getTop[0]?.bebida ? getTop[0]?.bebida : null
                }}
                second={{
                  total: getTop[1]?.cantidadFinal ? getTop[1]?.cantidadFinal : null,
                  name: getTop[1]?.bebida ? getTop[1]?.bebida : null
                }}
                third={{
