  ...
  return (
    <>
      <div className="checkout layout-primary">
        ...
        <TextArea label="Observaciones sobre la orden:" inputProps={{placeholder: "Explica si existen cambios que quieras
hacer sobre tu orden y el local hará lo 
posible para realizarlos."}}/>
        {/* RESUMEN DE LA ORDEN */}
