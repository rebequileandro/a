...
export const PopupPaymentMethod = ({setIsPopUp, setMethod}) => {
  return (
    <div className='popoup-overlay' onClick={() => setIsPopUp(false)}>
        <div className='popup'>
            <div className='content' onClick={() => setMethod({name: 'shoocoins', icon: shoocoins})}>
                <div className='image'>
            ...
            <div className='content' onClick={() => setMethod({name: 'efectivo', icon:cash})}>
                ...
                <hr/>
            <div className='content' onClick={() => setMethod({name: 'tarjet', icon: creditCard})}>
                <div className='image'> 
                    <img src={creditCard} alt="credit card"/>
                </div>
                <h2>tarjeta {'tarjet'}</h2>
            </div> 
                <hr/>
