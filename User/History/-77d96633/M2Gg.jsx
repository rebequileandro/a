...
import { getStatisticsDetailsHistory, getStatisticsDetailsTop5, getStatisticsDetailsTotal } from '../../../../redux/store/slices/Organizer'
      ...
      <>
        ...
        <div className="data-container">
            ...
            type === "total-facturado" ? (
                ...
                data={{
                    name: e.bebida,
                    total: `${e.cantidadFinal} ${e.cantidadFinal === 1 ? "un" : "uns"}`
                }}
                />
            ) : null)}
            <hr />
