...
export const formatDateNumber = (date) => {
    ...
    const day = ('0' + setDate.getDate()).slice(-2); // Añadir un 0 al principio si el día es menor a 10
    const month = ('0' + (setDate.getMonth() + 1)).slice(-2); // Sumar 1 al mes, ya que los meses van de 0 a 11
    const year = ('' + setDate.getFullYear()).slice(-2); // Tomar los últimos dos dígitos del año
