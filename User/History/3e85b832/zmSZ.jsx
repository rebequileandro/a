...
import { ToggleSwitch } from '../../../../components/organizer/ToggleSwitch/ToggleSwitch'
import { useDispatch, useSelector } from 'react-redux'
import { upDateDrinks, catchStatus } from '../../../../redux/store/slices/Organizer'
import { StatusPopUp } from '../../../../components/StatusPopUp/StatusPopUp'
export const EditProduct = ({id, image, name, price, status, setIsEdit, discount, type}) => {
    ...
    const handleSubmit = () => {
        ...
        let allData = [getAllDrinks, getAllBottles , getAllPacks, getAllAdditional]
        let newData = []
        if(type === 'drink') {
        ...
        if(type === 'additional') {
            drink = getAllAdditional.filter(e => e.nameDrink === name)
        }
        drink = {
            ...drink[0], 
  ...
  return (
    <div className='edit-product-overlay'>
        ...
        <div className='edit-popup'>
            ...
            <div className={`buttons-container ${type === "packs" && "save-packs"}`}>
                <button className='save' onClick={(e) => handleSubmit(e)}>Aceptar</button>
                { type === 'packs' && <button className='remove'>Eliminar del menu</button>}
            </div>
        </div>
        : <StatusPopUp
