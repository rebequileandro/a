...
snake_body_color_one = "#4E9C56"
snake_body_color_two = "#27712F"
last_segment_color = snake_body_color_one
...
#Score
score = create_element("white","circle" , {"x": 0, "y": 255})
score.hideturtle()
...
while True:
    ...
    if head.distance(food) < 20:
        ...
        #Growing body
        if len(segment)%2 == 0:
              last_segment_color = snake_body_color_two
        else: last_segment_color = snake_body_color_one
