...
export const Products_Categories = ({
  ...
  const cardProps = {
    ...
    oldPrice:
      'parseInt(product.priceDrink) === parseInt(product.finalPriceDrink) ? false : product.priceDrink',
  ...
  const parseProp = JSON.parse({ ...cardProps });
  return (
    <>
