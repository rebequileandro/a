...
export const Cashier = ({name}) => {
    ...
    useEffect(() => {
      ...
      if(JSON.parse(order.paymentCompledPayment) === false && JSON.parse(order.qrRead) === false) {
        setStatusOrder('cobrar')
      } else {
        setStatusOrder('cobrado')
      }
    }, [data])
  return (
    <div className='cashier-container'>
       ...
       <Ticket status={statusOrder} order={order}/> : null}
        <button 
