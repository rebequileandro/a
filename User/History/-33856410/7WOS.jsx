    ...
    <div className='cashier-container'>
        ...
        {isOpen && 
            <QrScanner 
                setIsOpen={setIsOpen} 
                setData={setData}/>}
       {order?.orderPayment?.length && !isOpen ?  <Ticket status={JSON.parse(order.paymentCompledPayment) === false && JSON.parse(order.qrRead) === false ? 'cobrar' : 'cobrado'} order={order}/> : null}
        <button 
