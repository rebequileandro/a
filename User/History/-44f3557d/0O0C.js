...
import inPreparation from './assets/notifications/in_preparation.png'
...
self.addEventListener('push', (e) => {
  ...
  self.registration.showNotification(data.title, {
    body: data.message,
    badge: badge,
    icon: data.orderStage === ORDER_STATUS.IN_PREPARATION ? inPreparation : data.orderStage === ORDER_STATUS.GET_READY ? getReady : data.orderStage === ORDER_STATUS.ORDER_READY ? ready :
      shooza,
