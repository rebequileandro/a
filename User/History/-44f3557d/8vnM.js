...
self.addEventListener('push', (e) => {
  ...
  self.registration.showNotification(data.title, {
    body: data.message,
    badge: badge,
    icon: data.title === "Tu pedido esta en preparación" ? inPreparation : data.title === "¡Prepárate para retirar tu pedido!" ? getReady : data.title === "¡Tu pedido está listo!" ? ready :
      shooza,
