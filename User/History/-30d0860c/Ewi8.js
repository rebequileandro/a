  ...
  return (
    <div className="app">
      ...
      <div className="app__btn-container">
        <button className="btn" onClick={startRecorder}>
          <Recorder />
        </button>
        <button className="btn" onClick={stopRecorder}>
          <Unrecorder />
        </button>
        <a className={`btn btn--primary ${recorded ? "" : "disabled"}`} href={recorded} target="_blank" rel="noopener noreferrer">view</a>
        <a className={`btn btn--primary ${recorded ? "" : "disabled"}`} href={recorded} download={"screen-recorder.webm"} rel="noopener noreferrer">
          <Download />
        </a>
      </div>
    </div>
