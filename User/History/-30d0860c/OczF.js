  ...
  return (
    <div className="app">
      ...
      <div className="app__btn-container">
        ...
        <a className="btn btn--secondary" href={recorded} target="_blank" rel="noopener noreferrer">view</a>
        <a className="btn" href={recorded} download={"screen-recorder.webm"} rel="noopener noreferrer">download</a>
      </div>
    </div>
  );
}
