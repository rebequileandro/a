...
export const SelectDrink = ({selected, setSelected, setStatus, setIsOpenStatusPopup, id}) => {
    ...
    const handleSubmit = (e) => {
      ...
      let allData = []
      let newData = []
      selected === 'botellas' ? allData = [getAllDrinks, getAllPacks, drinks] :
      selected === 'tragos' ? allData = [getAllBottles , getAllPacks, drinks] :
    ...
    <div className='popup-select-drink-overlay'>
      <div className='popup-select-drink'>
          ...
          <div className='add-drink-buttons'>
            {newPack.imageDrink.length > 1 ? <button className='save' onClick={() => setIsCreate(true)}>Siguiente</button>
