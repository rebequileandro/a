  ...
  return (
    <div className="footer-container" id="download">
      ...
      <div className="shapes">
         <img src={EllipseFooter_2} alt="ellipse" className="egg2" loading="lazy" />
         <img src={EllipseFooter_1} alt="ellipse" className="egg1" loading="lazy" />
         <img src={EllipseFooter_3} alt="ellipse" className="egg3" loading="lazy" />
      </div>
    </div>
  );
};
