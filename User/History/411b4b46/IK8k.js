...
// const loginFacebook = () => window.open(`${REACT_APP_API}/auth/facebook`, '_self');
...
const handleClick = (login) => {
  if (login === "google") {
    ...
    window.open(`${REACT_APP_API}/auth/apple`, '_self');
  }
}
...
export const loginMethods = navigator.userAgent.match(/Android/i)
  ? loginMethodsAndroid
  : loginMethodsApple;
