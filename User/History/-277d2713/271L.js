    ...
    reducers:{
        ...
        setStatisticsTop5: (state, action) => {
            const top = {
               ...
               total : action.payload.ventasTop.reduce((a, b) => parseInt(a.cantidadFinal) + parseInt(b.cantidadFinal))
            }
            console.log(action.payload.ventasTop.reduce((a, b) => parseInt(a.cantidadFinal) + parseInt(b.cantidadFinal)))
