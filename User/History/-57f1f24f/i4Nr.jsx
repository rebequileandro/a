...
import credential2 from "../../assets/credential-back.webp";
...
const NextDatesCard = (props) => {
  ...
  console.log(new Date(props.date) < new Date());
  return (
    <div
    ...
    >
      <div className="next-dates-card__image-wrapper--inner " ref={cardRef}>
        <div className="next-dates-card__image-wrapper--front">
          <div className="next-dates-card__image-data-container">
            ...
            <div className="next-dates-card__text-container">
              <h3>{props.city}</h3>
              <h3 className="next-dates-card__country">{props.country}</h3>
              <h3>{formatDate(props.date)}</h3>
            </div>
            {(!props.availability || new Date(props.date) < new Date()) && (
              <img
