...
const LinkedAccounts = () => {
  ...
  let namePoint = getMyParty?.nameParty.split(' ')[0];
  ...
  return (
    <>
      <div className="linked-accounts layout-primary">
        <Header
          party={getMyParty?.nameParty}
          logoParty={getMyParty?.imageParty}
      ...
      <LinkedPopup
        ...
        club={getMyParty?.nameParty}
      />
      <StatusPopUp
        isOpen={statusPopup}
        title={statusPopup.title}
        redirect={() => setStatusPopup(false)}
        button={'Aceptar'}
        status={statusPopup.status === 200}
      />
    </>
  );
};
