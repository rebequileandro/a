...
import iconX from '../../../../assets/icons/icon_close.svg';
        ...
        <div className="new-bottle-overlay">
          <>
            ...
            {!isOpen && (
              ...
              >
                <button className="new-bottle-popup__close">x</button>
                ...
                {categorySelect && brandSelect ? (
                  <div className="new-bottle-popup__search-category">
                    <SearchBar
                      input={input.mlByBottle}
                      handleChange={(e) => handleInputCange(e, 'mlByBottle')}
                      notIcons={true}
                      placeholder={'Mililitros por botellas'}
                      inputNumber={true}
                    />
                  </div>
                ) : null}
                {categorySelect && input.mlByBottle ? (
                  <div className="new-bottle-popup__search-category">
                    <SearchBar
