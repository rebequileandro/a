...
const StatisticsDetails = lazy(() =>
  import('./Statistics/StatisticsDetails/StatisticsDetails')
);
const DetailsCategories = lazy(() =>
  import('./Menu/Categories/DetailsCategories')
);
const Support = lazy(() => import('../global/Settings/Support/Support'));
const SelectStatistics = lazy(() =>
  import('./Statistics/SelectStatistics/SelectStatistics')
);
...
const LinkedAccounts = lazy(() =>
  import('../owner-manager/SettingsClubs/LinkedAccounts/LinkedAccounts')
);
...
export default function RoutesOwner() {
  const routesOwnew = useRoutes([
    ...
    {
      path: `${routes.owner.linkedAccounts}/:id`,
