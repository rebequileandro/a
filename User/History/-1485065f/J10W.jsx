...
import { deleteParty, fetchParty } from '../../../../redux/store/slices/Organizer'
export const DeletePary = ({setIsOpen, id}) => {

    const dispatch = useDispatch()
    const navigate = useNavigate()
    const handleDelete = () => {
        dispatch(deleteParty({"statusParty": false}, id))
        .then(response => {
    ...
    <div className='overlay'>
        <div className='delete-popup'>
            ...
            <div className='buttons-popup'>
                ...
                <button onClick={(e) => handleDelete(e)} className='confirm-button '>Eliminar</button>
            </div>
        </div>
    </div>
  )
