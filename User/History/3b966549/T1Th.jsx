...
import party from '../../../assets/icons/icon_party.svg'
...
import selectedParty from '../../../assets/icons/Selected-Icons.selected_party.svg'
  ...
  return (
    <div className='tabbar-container'>
        ...
        <button onClick={() =>  navigate('/myParty')}>
            <img src={active === 'party' ? selectedDrinks : party} alt="drinks"/>
        </button>
        <button>
