  ...
  return (
    <>
      ...
      <form className="settings-clubs layout-primary">
        ...
        <div className="settings-clubs__description">
          <p>
            Le enviamos un mail a <span>{input.name}</span> con las indicaciones
            para crear su cuenta de WeDrink para{' '}
            <span>{role === 'bartender' ? 'Bartenders' : 'Cajeros'}</span>.
          </p>
        </div>
