...
const Cam = ({ active, verified }) => {
  ...
  const capturePhoto = () => {
    ...
    // link.download = 'captura_de_camara.png';
  ...
  const detectFaces = async () => {
    ...
    resizedDetections.forEach((detection) => {
      ...
      if (isInOval) {
        ...
        if (faceSize > displaySize.width * displaySize.height * 0.2) {
  ...
  return (
    <div
      ...
      // ${isNearOval || isVerified ? "near-oval" : ""}
    >
      <div className="cam" ref={camRef}>
        <canvas className="cam__img" ref={canvasRef} width="168" height="210" />
        <video
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="100%" stopColor="#3b08ff" />
          </linearGradient>
        </defs>
      </svg>
    </div>
