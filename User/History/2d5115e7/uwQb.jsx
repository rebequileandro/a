...
export const Categories = ({title, categorie, id, setCategoryType}) => {
  const handleOnClick = () => {
    setCategoryType(categorie[0].typeDrink)
  }
console.log(categorie[0].typeDrink)
  return (
    <div className='categories-container'>
    <div className='header'>
          <h2>{title}</h2>
          <div className='see-more'>
            <GradientText text={'Ver Todos'} redirect={'/organizer/menu/:id/details'}/>
          </div>
        </div>
