...
export default function PosMercadoPagoQr({ total, socket }) {
  ...
  const [nameClientePayment, setNameClientePayment] = useState('');
  ...
  const getQr = async () => {
    try {
      ...
      console.log('response de qr', response);
  ...
  const cancelOrder = async () => {
    try {
      ...
      console.log('cancelar orden', response.data);
    } catch (err) {
      console.log(err);
    }
  ...
  console.log(nameClientePayment);
  return (
    <>
      <div className="pos-mercado-pago-qr">
        {!loading && qrCode.data ? (
          <>
            <InputDiv
              inputProps={{
                name: 'nameClientePayment',
                type: 'text',
                placeholder: 'Nombre de cliente'
              }}
              setState={setNameClientePayment}
            />
