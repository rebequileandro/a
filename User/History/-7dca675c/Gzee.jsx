...
const IntroSlider = () => {
  ...
  const handleNextElement = () => {
    currentSlide === 2 ? navigate(ROUTES.LOGIN) : swiper?.slideNext();
  };
  ...
  return (
    <div className="intro-slider logo-bg">
      <Swiper
      ...
      >
        {sliderContent?.map((slide) => (
          <SwiperSlide key={slide.title} className="intro-slider__swiper-slide">
