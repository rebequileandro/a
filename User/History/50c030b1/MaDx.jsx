...
const SelectDate = () => {
  ...
  const polaroidContainerRef = useRef();
    ...
    if (polaroidContainerRef.current) {
      if (!selectedId) {
        intervalId = setInterval(() => {
          polaroidContainerRef.current.classList.remove(classNameAnimation);
          setTimeout(() => {
            polaroidContainerRef.current.classList.add(classNameAnimation);
          }, 1000);
        }, 8000);
      }
    ...
    <>
      ...
      <section className="select-date">
        ...
        <div
          ...
          className="select-date__easter-egg-btn select-date__easter-egg-btn--animate"
        >
          <img
            ref={polaroidRef}
            key={2023}
            ...
            alt="bizarrap polaroid"
            className="select-date__easter-egg-btn__image"
          />
        </div>
