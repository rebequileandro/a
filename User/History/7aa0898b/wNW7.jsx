...
const PersonalInformation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (newInputErrors.email || newInputErrors.dateOfBirth) {
      setInputErrors({
        ...inputErrors,
        name: newInputErrors.name,
        dateOfBirth: newInputErrors.dateOfBirth
      });
      return;
    } else {
      try {
      } catch (error) {
        setInputErrors({ ...inputErrors, server: error });
      }
    }
  };
  return (
        ...
        <form onSubmit={handleSubmit} className="account__form">
          ...
          <div
            className={`input-div datepicker ${
              (inputErrors.dateOfBirth || inputErrors.server) && 'error'
            }`}
          >
            ...
            {(inputErrors.dateOfBirth || inputErrors.server) && (
              <p className="error">
                *
