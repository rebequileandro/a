...
import { updateRecap } from "pages/Recap/services/recap.services";
...
const EditRecap: React.FC<EditInterface> = (prop) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    new Date(prop.date) === new Date(inputState.date) && delete data.date;
    ...
    !Object.keys(inputState.filePortada).length && delete data.filePortada;
    ...
    //
    //
    console.log(new Date(prop.date) === new Date(inputState.date));
