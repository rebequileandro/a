...
export const OrganizerSettings = () => {
  ...
  return (
    <div className='organizer-settings-container'>
        ...
        <div 
            className='row-container'
            onClick={() => window.location.href = "https://auth.mercadopago.com.ar/authorization?client_id=1228194246381160&response_type=code&platform_id=mp&redirect_uri=http://localhost:3000/ajustes"}>
