...
const {REACT_APP_MP_CLIENT_ID, REACT_APP_MP_CLIENT_SECRET, REACT_APP_MP_REDIRECT} = process.env
export const OrganizerSettings = () => {
  ...
  console.log(REACT_APP_MP_CLIENT_ID, REACT_APP_MP_CLIENT_SECRET, REACT_APP_MP_REDIRECT)
  return (
