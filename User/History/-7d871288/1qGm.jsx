  ...
  return (
    <div className="inventory-container">
      <div className="smartphone-container">
        ...
        <span id=""  className="ellipse-pink four" />
        <span id="traslate-bottom-to-top" className="ellipse-pink five" />
        <span id="traslate-top-to-bottom" className="ellipse-pink six" />
