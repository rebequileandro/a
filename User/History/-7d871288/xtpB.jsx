  ...
  return (
    <div className='inventory-container'>
        <div className='smartphone-container'>
            <img className='smartphone_4' src={smartphone_4} alt="smartphone wedrink" />
            <img className='smartphone_3' src={smartphone_3} alt="smartphone wedrink" />
        </div>
        <div className='content-right'>
            ...
            <ul>
                <li className='item one'>Personaliza tu carta en cuestión de segundos</li>
                <li className='item two'>Arma los mejores packs para tus clientes</li>
                <li className='item three'>Cada pedido se resta automáticamente del inventario</li>
                <li className='item four'>Notificaciones cuando hay escasez de mercadería</li>
            </ul>
