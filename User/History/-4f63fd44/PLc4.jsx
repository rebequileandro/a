  ...
  return (
    <div className="tabbar-container">
      <button onClick={() => navigate("/")}>
        <img src=
        {active === "home" ? selectedHome : home} alt="home" />
      </button>
      <button onClick={() => navigate(`${currentUser.rol === "unitManager" ? '/inventario/' + currentUser.idParty : "/actividades"}`)}>
...
export default TabbarOrganizer;
