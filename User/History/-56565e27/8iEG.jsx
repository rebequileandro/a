...
export const DinamincCard = ({input}) => {
  ...
  return (
    <div className='card'>
            ...
            { cardLogo === maestro ? <img className='card-logo' src={maestro} alt="card-logo"/> :
              cardLogo === mastercard ? <img className='card-logo' src={mastercard} alt="card-logo"/> :
              cardLogo === visa &&  <img className='card-logo' src={visa} alt="card-logo"/>}
