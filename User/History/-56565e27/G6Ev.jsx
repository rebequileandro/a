...
export const DinamincCard = ({input}) => {
  ...
  return (
    <div className='card'>
            ...
            { cardLogo === maestro ? <img className='card-logo maestro' src={maestro} alt="card-logo"/> :
              cardLogo === mastercard ? <img className='card-logo mastercar' src={mastercard} alt="card-logo"/> :
              cardLogo === visa &&  <img className='card-logo visa' src={visa} alt="card-logo"/>}
