...
export const DinamincCard = ({input}) => {
    ...
    if(input.cardNumber.length === 2){
        ...
        if(input.cardNumber[0].concat(input.cardNumber[1]) === '22' || 
           input.cardNumber[0].concat(input.cardNumber[1]) === '27' ||
           input.cardNumber[0].concat(input.cardNumber[1]) === '51' ||
           input.cardNumber[0].concat(input.cardNumber[1]) === '55'){
            setTimeout(() => {
                setCardLogo(visa)
            }, 1000);
        }
