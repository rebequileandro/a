...
const EditRole = ({ role }) => {
  ...
  useEffect(() => {
    if (role === 'bartender' || role === 'newBartender') {
    ...
    if (role === 'cashier' || role === 'newCashier') {
        ...
        >
          ...
          {role !== 'unitManager' ? (
            <Select
              ...
              initialState={
                role === 'bartender' || role === 'cashier' ? input.square : null
              }
              options={
                role === 'bartender' || role === 'newBartender'
                  ? getBartenders.map((e) => e.square)
                  : getCashiers.map((e) => e.square)
              }
              gradient
              icon
            />
