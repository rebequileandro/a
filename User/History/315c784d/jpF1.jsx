...
const Order_Item = ({
  ...
  const [timerHalfTime, setTimerHalfTime] = useState(null);
  const [timerOrderIsReady, setTimerOrderIsReady] = useState(null);
  ...
  */
  ...
  useEffect(() => {
    ...
    return () => {
      clearTimeout(timerHalfTime);
      clearTimeout(timerOrderIsReady);
    };
  }, [status]);

  console.log(timerOrderIsReady);
              ...
              <div className="order-ready">
                {remainingTime ? (
                  <div className="order-ready__timer">
                    <Countdown timeLeft={remainingTime} />
                  </div>
