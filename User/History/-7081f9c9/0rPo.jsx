  ...
  return (
    <nav className="tabbar-space">
      <div className="tabbar">
        <NavLink 
          to="/" 
          className={(navigation) => navigation.isActive ? "active home" : null}>
          <img
            loading="lazy"
            src={homeIcon}
            alt="Home"
        ...
        <NavLink 
          to="/marketplace"
          className={(navigation) => navigation.isActive ? "active marketplace" : null}>
        ...
        <NavLink 
          to="/activities"
          className={(navigation) => navigation.isActive ? "active activities" : null}>
          <img
            loading="lazy"
            src={
