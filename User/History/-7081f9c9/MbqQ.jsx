  ...
  return (
    <nav className="tabbar-space">
      <div className="tabbar">
        <NavLink 
          to="/" 
          className={(navigation) => navigation.isActive && "active_home"}>
          <img
            loading="lazy"
            src={homeIcon}
            alt="Home"
        ...
        <NavLink 
          to="/marketplace"
          className={(navigation) => navigation.isActive && "active_marketplace"}>
          <img
            loading="lazy"
            src={drinksIcon}
            alt="Marketplace"
        ...
        <NavLink 
          to="/activities"
          className={(navigation) => navigation.isActive && "active_activities"}>
          <img
            loading="lazy"
            src={activitiesIcon}
            alt="Actividades"
        ...
        <NavLink 
          to="/settings"
          className={(navigation) => navigation.isActive && "active_settings"}>
          <img
            loading="lazy"
            src={settingsIcon}
            alt="Configuración"
