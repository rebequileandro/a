...
export const TypeOfDrink = ({setIsOpen, id}) => {
  ...
  const handleClick = (value) => {
      ...
      if(value === 'sin alcohol') {
        let additionalAll = addIdParty.filter(e => e.typeDrink === "additional")
        dispatch(selectDrinks(getAllAdditional.length ? getAllAdditional : additionalAll)) 
      }
      setTimeout(() => {
        setSelected(value)
      }, 1000);
    ...
    <div className='overlay-type-of-drink'>
      ...
      <div className='type-of-products-popup'>
            ...
            <div className='type-of-products'>
                ...
                <div className='card-container' onClick={() => handleClick('sin alcohol')}>
