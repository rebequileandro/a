...
export const TypeOfDrink = ({setIsOpen}) => {
  ...
  const handleClick = (value) => {
      ...
      if(value === 'botellas') {
        let bottles1 = getAllDrinks.filter(e => e.typeDrink === "bottle")
        let bottles2 = addIdParty.filter(e => e.typeDrink === "bottle")
        let botteles = bottles1 ? bottles1 : bottles2
        console.log(botteles)
        dispatch(selectDrinks(bottles1.length ? bottles1 : bottles2)) 
      }
      // if(value === 'packs') {
