            ...
            <>
               {isOpen ? 
                <StatusPopUp
                    ...
                    title={status === 200 ? "su botella se ha agregado con exito" : "no se pudo agregar su botella"}
                    button={"volver"}
                    redirect={() => setIsnewBottle(false)}
                    description={status !== 200 ? "intentalo de nuevo, asegurate de completar todos los datos" : false}
                />
                :
                <motion.div 
