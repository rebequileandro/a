...
import "./contact.scss";
import showControl from "assets/show-control_3.svg";
import emailIcon from "assets/email_icon.svg";
import phoneIcon from "assets/phone_icon.svg";
import showControlBg from "assets/show-control.svg";
  ...
  return (
    <section ref={setReference} id="contacto" className="contact">
      <img
        src={showControlBg}
        alt="show-control"
        className="contact__graphics__show-control-bg"
      />
      ...
      <div className="contact__info-container">
        ...
        <div className="gradient-line contact__graphics__line" />
      </div>
      <img
        src={showControl}
        alt="show-control"
