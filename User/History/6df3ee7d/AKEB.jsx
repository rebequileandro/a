...
const FormBottle = ({ setOption }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (menu) {
      ...
      } else if (previewImage === addImage) {
        setError("Selecciona una imagen");
      } else {
        try {
          const formData = new FormData();
          formData.append("imageDrink", image);
          ...
          //   {
          //     imageDrink: image,
          //     typeDrink: inputBottle.typeDrink.toLowerCase(),
          //     nameDrink: inputBottle.nameDrink.toLowerCase(),
          //     activeDrink: false,
          //     totalMinOrder: 1,
          //     recipe: [
          //       {
      ...
      <form className="form-card__form-container" onSubmit={handleSubmit}>
        <div className="form-card__row">
          ...
          <div className="form-card__right-container">
            {menu && <AddImage setState={setPreviewImage} />}
            <Checkbox
              label="Menú"
