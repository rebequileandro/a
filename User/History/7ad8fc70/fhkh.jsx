  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="card-modal__creator">
          <div className="card-modal__creator-img-container">
            <img
              className="card-modal__creator-img"
              src={datamodal.authorImage}
              alt="creator"
            />
          </div>
          <div className="card-modal__creator-info">
            <p className="highlighted">Caso creado por:</p>
