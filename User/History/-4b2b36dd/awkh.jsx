...
const Party = () => {
  ...
  const initialStateInput = {
    // file: "",
    idOrganizer: window.localStorage.getItem("lastOrganizerID")
      ? window.localStorage.getItem("lastOrganizerID")
      : "6322eb91034b3a5b276623be",
    category: "Techno",
    nameParty: "",
    addressParty: "",
    bartender: [],
  ...
  const onSubmitForm = async (e) => {
    ...
    formAddParty.append("idOrganizer", inputData.idOrganizer);
    formAddParty.append("addressParty", inputData.addressParty);

    // formAddParty.append("cashier", JSON.stringify(inputData.cashier));
    // formAddParty.append("bartender", JSON.stringify(inputData.bartender));
    formAddParty.append("barras", JSON.stringify(inputData.barras));
    for (let [key, value] of formAddParty.entries()) {
        ...
        <section className="form-section">
          ...
          <form className="form">
            <fieldset className="form__address-name">
              <legend>ID del organizador</legend>
              <input
                type="text"
                id="idOrganizer"
                name="idOrganizer"
                value={inputData.idOrganizer}
